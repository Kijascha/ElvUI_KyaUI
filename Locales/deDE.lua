...
-- General Options
L["Plugin for |cffff7d0aElvUI|r by\nKeYara."] = "Plugin für |cffff7d0aElvUI|r von\nKeYara."
L["by KeYara (|cFF00c0faEU-Ulduar|r)"] = "von KeYara (|cFF00c0faEU-Ulduar|r)"
L["AFK"] = true
...
L["KYA_DESC"] = [=[|cffc74040Kya|cffe3e3e3UI|r]=]
...
L["DataBars Texture"] = "Textur"
L["The texture that will be used only for databars."] = "Diese Textur wird nur für die Informationsleisten verwendet."
...
L["AzeriteBar"] = "Azeriteleiste"
L["HonorBar"] = "Ehrenleiste"
...
L["Timer Only"] = "Nur Text"
L["Static Icon"] = "|cffa93535Statisches Symbol|r"
L["Dynamic Icon"] = "|cffa93535Dynamisches Symbol|r"
...
-- General
L["General"] = "Allgemein"
L["Setup General Layout"] = "Allgemeines Layout einrichten"
L["General Layout Set"] = "Allgemeines Layout gesetzt"
...
L["Setup Unitframes"] = "Einheitenfenster einrichten."
L["This part of the installation process will reposition your Unitframes."] = "Einheitenfenster einrichten.\r\rDieser Teil der Installation positioniert die Einheitenfenster."
L["Unitframes Set"] = "Einheitenfenster gesetzt"
L["Protection"] = "Schutz"
L["Heal"] = "Heilung"
L["DD w/o Pet"] = "Schaden ohne Pet"
L["DD w/ Pet"] = "Schaden mit Pet"
L["Please click the role button of your preference below to setup your unitframes by your chosen role."] = "Bitte klick auf die Rollen-Taste deiner Wahl unten, um das Einheitenfenster entsprechend deiner gewählten Rolle einzustellen."
-- Unitframes - Filter Extension
L["Colored Static Icon"] = "Buntes statisches Symbol"
L["Colored Watch Icon"] = "Buntes Uhren-Symbol"
L["Filter Extension"] = "Filter-Erweiterung"
L["Filter Extension Desc"] = "Schalte einige verbesserte Optionen für die Filter-Sektion von ElvUI frei, inspiriert von Grid2 z.B. ein buntes Uhren-Symbol mit bunten Schwellenwerten oder ein statisches buntes Symbol."
L["Select filters"] = "Filterauswahl"
L["No filter selected"] = "Kein Filter ausgewählt"
L["Selected filter: %s"] = "Ausgewählter Filter: %s"
L["Selected filter: %s - Selected spell: %s (%s)"] = "Ausgewählter Filter: %s - Ausgewählter Zauber: %s (%s)"
L["Selected filter: %s - No spell selected"] = "Ausgewählter Filter: %s - Kein Zauber ausgewählt"
L["Threshold configuration"] = "Schwellen-Konfiguration"
L["Number of stacks"] = "Stapelanzahl"
L["Remaining time"] = "Verbleibende Zeit"
L["Elapsed time"] = "Verbrauchte Zeit"
L["Color count"] = "Anzahl der Farben"
L["Select how many colors the selected spell status must provide."] = "Wähle die Anzahl der Farben aus, die der ausgewählte Zauber-Status bereitstellen soll."
L["Coloring based on"] = "Einfärben basiert auf"
L["Select the threshold-type the coloring is based on."] = " Wähle den Schwellen-Typ auf dem das Einfärben basiert."
-- DataBars
L["Setup Databars"] = "Informationsleisten einrichten."
L["DataBars Set"] = "Informationsleisten gesetzt"
-- ActionBars
L["ActionBars"] = "Aktionsleisten"
L["Setup ActionBars"] = "Aktionsleisten einrichten"
...
-- Staticpopup
L["MSG_KYA_ELV_OUTDATED"] = "Deine Version von ElvUI ist älter als die empfohlene Version um |cffff7d0aMerathilisUI|r zu nutzen. Deine Version ist |cff00c0fa%.2f|r (empfohlen ist |cff00c0fa%.2f|r). Bitte aktuallisiere dein ElvUI, um Fehler zu vermeiden!"
